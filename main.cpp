...
const complex<double> omega0 = complex<double>(0.0001, 0.0);
...
const complex<double> omega1 = complex<double>(0.0001, 0.0);
...
const complex<double> omega2 = complex<double>(0.0001, 0.0);
...
const complex<double> omega3 = complex<double>(0.0001, 0.0);
...
const complex<double> omega4 = complex<double>(0.0001, 0.0);
...
const complex<double> omega5 = complex<double>(0.0001, 0.0);
...
const complex<double> omega6 = complex<double>(0.0001, 0.0);
...
const complex<double> omega7 = complex<double>(0.0001, 0.0);
...
struct diff_system
{
    ...
    {
        dxdt[0] = (-I) * ((nu0 + x0 * omega0 * x[8]) * x[0] + nu01 * x[1]);
        dxdt[1] = (-I) * ((nu1 + x1 * omega1 * x[10]) * x[1] + nu10 * x[0] + nu12 * x[2]);
        dxdt[2] = (-I) * ((nu2 + x2 * omega2 * x[12]) * x[2] + nu21 * x[1] + nu23 * x[3]);
        dxdt[3] = (-I) * ((nu3 + x3 * omega3 * x[14]) * x[3] + nu32 * x[2] + nu34 * x[4]);
        dxdt[4] = (-I) * ((nu4 + x4 * omega4 * x[16]) * x[4] + nu43 * x[3] + nu45 * x[5]);
        dxdt[5] = (-I) * ((nu5 + x5 * omega5 * x[18]) * x[5] + nu54 * x[4] + nu56 * x[6]);
        dxdt[6] = (-I) * ((nu6 + x6 * omega6 * x[20]) * x[6] + nu65 * x[5] + nu67 * x[7]);
        dxdt[7] = (-I) * ((nu7 + x7 * omega7 * x[22]) * x[7] + nu76 * x[6]);
        dxdt[8] = x[9];
        dxdt[9] = -omega_0_shtrix * x[9] - omega0 * x[8] - norm(x[0]);
        dxdt[10] = x[11];
        dxdt[11] = -omega_1_shtrix * x[11] - omega1 * x[10] - norm(x[1]);
        dxdt[12] = x[13];
        dxdt[13] = -omega_2_shtrix * x[13] - omega2 * x[12] - norm(x[2]);
        dxdt[14] = x[15];
        dxdt[15] = -omega_3_shtrix * x[15] - omega3 * x[14] - norm(x[3]);
        dxdt[16] = x[17];
        dxdt[17] = -omega_4_shtrix * x[17] - omega4 * x[16] - norm(x[4]);
        dxdt[18] = x[19];
        dxdt[19] = -omega_5_shtrix * x[19] - omega5 * x[18] - norm(x[5]);
        dxdt[20] = x[21];
        dxdt[21] = -omega_6_shtrix * x[21] - omega6 * x[20] - norm(x[6]);
        dxdt[22] = x[23];
        dxdt[23] = -omega_7_shtrix * x[23] - omega7 * x[22] - norm(x[7]);
    }
};
